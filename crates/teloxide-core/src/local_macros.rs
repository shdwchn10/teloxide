...
// Generated by `codegen_requester_forward`, do not edit by hand.
    ...
    (@method refund_star_payment $body:ident $ty:ident) => {
        ...
        fn refund_star_payment(&self, user_id: UserId, telegram_payment_charge_id: TelegramPaymentChargeId) -> Self::RefundStarPayment {
            let this = self;
            $body!(refund_star_payment this (user_id: UserId, telegram_payment_charge_id: TelegramPaymentChargeId))
        }
    };
    (@method edit_user_star_subscription $body:ident $ty:ident) => {
        type EditUserStarSubscription = $ty![EditUserStarSubscription];

        fn edit_user_star_subscription(&self, user_id: UserId, telegram_payment_charge_id: TelegramPaymentChargeId, is_canceled: bool) -> Self::EditUserStarSubscription {
            let this = self;
            $body!(edit_user_star_subscription this (user_id: UserId, telegram_payment_charge_id: TelegramPaymentChargeId, is_canceled: bool))
        }
    };
